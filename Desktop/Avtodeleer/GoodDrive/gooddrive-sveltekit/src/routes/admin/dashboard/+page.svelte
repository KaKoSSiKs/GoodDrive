            ...
            <tbody>
              {#each recentOrders as order}
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                  <td class="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-medium text-gray-900 font-mono">{order.orderNumber?.slice(0, 10) || 'N/A'}...</td>
                  <td class="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm text-gray-600">{order.customerName || '-'}</td>
                  <td class="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm text-gray-600 hidden md:table-cell">{order.customerPhone || '-'}</td>
                  <td class="py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-medium text-gray-900">{Number(order.totalAmount || 0).toLocaleString()} ₽</td>
